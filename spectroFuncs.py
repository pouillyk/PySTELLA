            ...
            for inLine in fIn:
                ...
                if inLine.strip()[0] != '#':
                    if i == 0:
                        ...
                        self.SB2 = inLine.split()[1]
                        self.LR = float(inLine.split()[2])
                    
                    elif i == 1:
                        self.period = float(inLine.split()[0])
                        self.vsini = float(inLine.split()[1])
                        self.inc = float(inLine.split()[2])
                        self.veil = float(inLine.split()[3])
                        self.periodB = float(inLine.split()[4])
                        self.vsiniB = float(inLine.split()[5])
                        self.incB = float(inLine.split()[6])
                        self.veilB = float(inLine.split()[7])
                        self.Porb = float(inLine.split()[8])
                    elif i == 2:
                        ...
                        self.tempNameB = inLine.split()[1]
                    elif i == 5+nb:
                        self.tempVrad = float(inLine.split()[0])
                        self.tempVsini = float(inLine.split()[1])
                        self.tempVradB = float(inLine.split()[2])
                        self.tempVsiniB = float(inLine.split()[3])
                    elif i == 6+nb:
                        self.tempPath = inLine.split()[0]
                        self.tempPathB = inLine.split()[1]
            ...
            for inLine in fIn:
                ...
                if inLine.strip()[0] != '#':
                    if i == 0:
                        ...
                        self.tempBHead = int(inLine.split()[0])
                    elif i == 7:
                        self.tempBUnit = inLine.split()[0]
                    elif i == 8 : 
                        self.tempBWL = int(inLine.split()[0])
                        self.tempBI = int(inLine.split()[1])
                        self.tempBSigI = int(inLine.split()[2])
                        self.tempBV = int(inLine.split()[3])
                        self.tempBSigV = int(inLine.split()[4])
                        self.tempBNull = int(inLine.split()[5])
                        self.tempBSigNull = int(inLine.split()[6])
